...
function create_openstack_networks() {
    ...
    SUBNET_ID=$(neutron subnet-create private 100.100.0.0/24 --gateway 100.100.0.2 --dns_nameservers list=true 8.8.8.8 | awk '{if (NR == 12) {print $4}}');
    ...
    SUBNET_ID=$(neutron subnet-create public 10.10.0.0/24 --gateway 10.10.0.2 --allocation-pool start=10.10.0.133,end=10.10.0.254 --disable-dhcp);
